int0_clear () {
    echo "INT0 clear"
    #./rw 0x40000008 0x01000001
    #./rw 0x40000008 0x00000001
    ./bit_write.sh 0x40000008 24 1
    ./bit_write.sh 0x40000008 24 0
...
int1_clear () {
    echo "INT1 clear"
    #./rw 0x40000008 0x10000001
    #./rw 0x40000008 0x00000001
    ./bit_write.sh 0x40000008 28 1
    ./bit_write.sh 0x40000008 28 0
    #./rw 0x4000000C 0xFFFFFFFF
    ./rw 0x40000008
    #./rw 0x4000000C 0x00000000
}
