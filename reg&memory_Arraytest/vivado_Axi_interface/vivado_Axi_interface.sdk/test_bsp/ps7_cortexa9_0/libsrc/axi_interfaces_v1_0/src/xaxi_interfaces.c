...
void XAxi_interfaces_Set_d_o(XAxi_interfaces *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XAxi_interfaces_WriteReg(InstancePtr->Axilites_BaseAddress, XAXI_INTERFACES_AXILITES_ADDR_D_O_DATA, Data);
}

u32 XAxi_interfaces_Get_d_o(XAxi_interfaces *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XAxi_interfaces_ReadReg(InstancePtr->Axilites_BaseAddress, XAXI_INTERFACES_AXILITES_ADDR_D_O_DATA);
    return Data;
}

void XAxi_interfaces_Set_d_i(XAxi_interfaces *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XAxi_interfaces_WriteReg(InstancePtr->Axilites_BaseAddress, XAXI_INTERFACES_AXILITES_ADDR_D_I_DATA, Data);
}

u32 XAxi_interfaces_Get_d_i(XAxi_interfaces *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XAxi_interfaces_ReadReg(InstancePtr->Axilites_BaseAddress, XAXI_INTERFACES_AXILITES_ADDR_D_I_DATA);
    return Data;
}
