set C_TypeInfoList {{ 
"axi_interfaces" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"d_o": [[], {"array": [ {"scalar": "int"}, [32]]}] }, {"d_i": [[], {"array": [ {"scalar": "int"}, [32]]}] }],[],""]
}}
...
set C_modelArgList {
	...
	{ d_o int 32 regular {axi_slave 0}  }
	{ d_i int 32 regular {axi_slave 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "d_o","cData": "int","bit_use": { "low": 0,"up": 31},"offset": { "type": "dynamic","port_name": "d_o"},"direction": "WRITEONLY","cArray": [{"low" : 0,"up" : 31,"step" : 1}]},{"cName": "d_i","cData": "int","bit_use": { "low": 0,"up": 31},"offset": { "type": "dynamic","port_name": "d_i"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 31,"step" : 1}]}]}]} , 
 	{ "Name" : "d_o", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":16}, "offset_end" : {"in":23}} , 
 	{ "Name" : "d_i", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":24}, "offset_end" : {"in":31}} ]}
...
set NewPortList {[ 
	{ "name": "s_axi_AXILiteS_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "AXILiteS", "role": "AWADDR" },"address":[{"name":"axi_interfaces","role":"start","value":"0","valid_bit":"0"},{"name":"axi_interfaces","role":"continue","value":"0","valid_bit":"4"},{"name":"axi_interfaces","role":"auto_start","value":"0","valid_bit":"7"},{"name":"d_o","role":"data","value":"16"},{"name":"d_i","role":"data","value":"24"}] },
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"Port" : [
			...
			{"Name" : "d_o", "Type" : "None", "Direction" : "I"},
			{"Name" : "d_i", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.axi_interfaces_AXILiteS_s_axi_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.axi_interfaces_gmem_m_axi_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	axi_interfaces {
		gmem {Type IO LastRead 9 FirstWrite 9}
		d_o {Type I LastRead 0 FirstWrite -1}
